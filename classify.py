...
def classify(filename='7_10_t4_a3d_v2.txt', useFrac=1.0, trainFraction=0.5, equalClassSize=True, 
             thres=0.5, useFeatures=[0,1,2,3,4,7,8,9,10,11,12], useAll=True, batch=False, useCache=True,
